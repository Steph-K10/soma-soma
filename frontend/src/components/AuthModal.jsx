    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition z-10"
          >
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              <h2 className="text-2xl font-display font-bold bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent">
                {mode === 'login' ? 'Welcome Back' : 'Join the Waitlist'}
              </h2>
              <p className="text-gray-600 dark:text-gray-400 mt-2">
                {mode === 'login' 
                  ? 'Sign in to continue your learning journey' 
                  : 'Be the first to experience SomaSoma'}
              </p>
            </div>
            ...
            {showVerificationMessage ? (
              <div className="text-center py-8">
                ...
                <button
                  onClick={onClose}
                  className="mt-6 px-4 py-2 rounded-lg bg-gradient-to-r from-pink-500 to-purple-600 text-white"
                >
                  Close
                </button>
              </div>
              ...
              <>
                ...
                <form onSubmit={mode === 'login' ? handleEmailLogin : handleEmailSignUp}>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-10 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-dark-primary focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                        required
                      />
                      <button
                        type="button"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-2 rounded-lg bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold hover:shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                  >
                    {loading ? (
